...
describe('profile address test', () => {
    ...
    it('ไม่กรอกชื่อ', () => {
        ...
        login.element.textHeader().should('contain', 'ที่อยู่')
    ...
    it('ไม่กรอกหมายเลขโทรศัพท์', () => {
        ...
        address.element.subDistrictDropdown().select('ลาดกระบัง')
        address.element.saveAddressBtn().click()
        cy.get('#divError_textPhoneNumber').should('contain', 'รูปแบบหมายเลขโทรศัพท์ไม่ถูกต้อง')
    })
    ...
    it('ไม่กรอกรหัสไปรษณีย์', () => {
        ...
        address.element.subDistrictDropdown().select('ลาดกระบัง')
        address.element.saveAddressBtn().click()
        cy.get('#divError_customerPostal').should('contain', 'รูปแบบรหัสไปรษณีย์ไม่ถูกต้อง')
    })
    ...
    it('ไม่เลือกเขต/อำเภอ', () => {
        ...
        address.element.regionsDropdown().select('กรุงเทพมหานคร')
        address.element.saveAddressBtn().click()
        cy.get('#divError_customerDistrictID').should('contain', 'กรุณากรอกเขต/อำเภอ')
    })
    ...
    it('ไม่เลือกแขวง/ตำบล', () => {
        ...
        address.element.districtDropdown().select('ลาดกระบัง')
        address.element.saveAddressBtn().click()
        cy.get('#divError_customerSubDistrictID').should('contain', 'กรุณากรอกแขวง/ตำบล')
    })
    ...
    it('แก้ไขที่อยู่ในการจัดส่ง', () => {
        address.element.addressBtn().click()
        cy.get(':nth-child(2) > :nth-child(4) > .editMemAdrrShipping > .svg-inline--fa > path').click()
    ...
    it('ลบที่อยู่ในการจัดส่ง', () => {
        address.element.addressBtn().click()
        cy.get(':nth-child(2) > :nth-child(5) > .delMemAdrrShipping > .svg-inline--fa').click()
